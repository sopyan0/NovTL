...
export const generateEpub = async (project: NovelProject, chapters: SavedTranslation[]) => {
  try {
    if (!chapters || chapters.length === 0) {
      throw new Error("Tidak ada bab yang dipilih untuk dibuat EPUB.");
    }
...
<container version="1.0" xmlns="urn:oasis:names:tc:opendocument:xmlns:container">
   <rootfiles>
    ...
    if (!oebps) throw new Error("Gagal membuat folder OEBPS di dalam ZIP.");
...
<ncx xmlns="http://www.daisy.org/z3986/2005/ncx/" version="2005-1">
  ...
  <navMap>
    ...
    throw new Error(`Gagal membuat EPUB: ${error.message}`);
  }
};
